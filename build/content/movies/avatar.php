...
<body class="bg-[#191919]">
    ...
    <div class="w-full">
        ...
        <div class="flex flex-row items-end w-full md:px-8">
            ...
            <div class="hidden md:block px-4 z-10">
                ...
                <?php
                // Output the image
                echo '<img src="data:image/jpeg;base64,'.getFilmPoster($pdo, 'avatar').'" class="h-full w-full object-cover" alt="Avatar" />';
                ?>
                </div>
            </div>
            ...
            <div class="grow px-4 pt-72 relative z-1 -tracking-tight md:max-w-[800px]">
                <div class="my-4">
                    <h1 class="text-[#F5EDF0] font-bold text-xl uppercase md:text-2xl"><?php echo getFilmTitle($pdo, 'avatar')?></h1>
                    <p class="text-[#F5EDF0] md:text-xl">
                        <?php echo getFilmDate($pdo, 'avatar') . ', ' . getFilmDuree($pdo, 'avatar') . ' - '?>
                        <span class="text-[#406E8E] font-bold"><?php echo getFilmGenre($pdo, 'avatar') ?></span>
                    </p>
                    <p class="text-[#F5EDF0] md:text-xl">
                      <?php echo getFilmSynopsis($pdo, 'avatar') ?>
                    </p>
                </div>
                ...
                <div class="my-4 md:text-xl">
                    <p class="text-[#F5EDF0] font-semibold">
                      Rélisateur : <span class="text-[#406E8E] font-bold">
                        <?php echo getRealFname($pdo, 'Cameron') . ' ' . getRealLname($pdo, 'Cameron') ?>
                      </span>
                    </p>
                    <p class="text-[#F5EDF0] font-semibold">
                      ...
                      $actors = getActorsFromMovie($pdo, 2);
    ...
    <div class="md:px-8 py-8 flex flex-col">
        ...
        <h1 class="px-4 text-[#FFD447] font-bold text-xl uppercase md:text-3xl">Où regarder <?php echo getFilmTitle($pdo, 'avatar')?></h1>
